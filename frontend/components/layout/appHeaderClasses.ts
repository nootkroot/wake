...
export const appHeaderAuthLink = `${appHeaderRowItem} transition-colors hover:text-[#FFE374]`;

export const appHeaderSignUpBtn =
  `${appHeaderRowItem} rounded-md border border-white/40 px-3 transition-colors hover:bg-white/10`;
